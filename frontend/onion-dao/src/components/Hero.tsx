          ...
          <div className="transaction-demo">
            ...
            <div className="demo-card">
              <div className="card-header">
                ...
                <div className="card-status status-private">Enhanced</div>
              </div>
              <div className="card-content">
                <div className="transaction-row">
                  <span className="tx-label">Privacy:</span>
                ...
                <div className="transaction-row">
                  <span className="tx-label">Speed:</span>
                  <span className="tx-value private">⚡ Instant</span>
                </div>
              </div>
            </div>
          </div>
